...
export const metadata: Metadata = {
  ...
  description:
    'Browse all Sprunki Beats puzzle categories. Explore Animals, Nature, Cities, Art, and Food levels with beginner-to-expert difficulty.',
  keywords: ['puzzle categories', 'jigsaw categories', 'Sprunki Beats categories'],
  alternates: {
