...
const SUPPORT_EMAIL = 'hello@sprunkibeats.online';

export const metadata: Metadata = {
    title: 'Contact Sprunki Beats',
    description: 'Get in touch with the Sprunki Beats team for support, feedback, partnerships, accessibility concerns, or privacy questions.',
    keywords: ['contact Sprunki Beats', 'Sprunki Beats support', 'game contact'],
    alternates: {
        canonical: '/contact',
    },
};
