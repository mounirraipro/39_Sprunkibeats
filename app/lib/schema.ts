...
const SITE_URL = 'https://sprunkibeats.online';
...
export function buildWebSiteSchema() {
    return {
        ...
        name: 'Sprunki Beats',
        url: SITE_URL,
        description: 'Play Sprunki Beats free online — no download, no account needed.',
        potentialAction: {
            '@type': 'SearchAction',
            target: {
                '@type': 'EntryPoint',
...
export function buildWebApplicationSchema() {
    return {
        ...
        description:
            'A free browser-based game. Play Sprunki Beats online instantly.',
        author: {
            '@type': 'Person',
            name: AUTHOR_NAME,
            url: AUTHOR_URL,
