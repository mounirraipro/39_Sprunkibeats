...
export const metadata: Metadata = {
    ...
    description: 'Read the Sprunki Beats Privacy Policy. Learn how we collect, use, and protect your personal data when you use our free online game.',
    keywords: ['Sprunki Beats privacy policy', 'data protection', 'cookie policy'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    At Sprunki Beats, we are committed to protecting your privacy and ensuring transparency
                ...
                <ul>
                    ...
                    <li>To protect the rights, property, or safety of Sprunki Beats, our users, or the public</li>
                </ul>

                <h2>5. Children&apos;s Privacy</h2>
                <p>
                    Sprunki Beats is designed to be family-friendly. We do not knowingly collect personal
                ...
                <p>
                    ...
                    <strong>privacy@sprunkibeats.online</strong>.
                </p>
            </div>
        </>
    );
