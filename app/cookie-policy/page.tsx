...
export const metadata: Metadata = {
    title: 'Cookie Policy',
    description: 'Learn about the cookies Sprunki Beats uses, why we use them, and how to manage your cookie preferences.',
    keywords: ['Sprunki Beats cookies', 'cookie policy', 'cookie preferences', 'tracking cookies'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    This Cookie Policy explains what cookies are, how Sprunki Beats uses them, and how you can
                ...
                <p>Sprunki Beats uses cookies for the following purposes:</p>
                ...
                <p>
                    We currently do not use any tracking or analytics cookies (such as Google Analytics) on Sprunki Beats.
                </p>
                ...
                <p>
                    ...
                    or email <strong>privacy@sprunkibeats.online</strong>.
                </p>
            </div>
        </>
    );
