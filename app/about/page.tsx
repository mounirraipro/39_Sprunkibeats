...
const aboutSchema = [
    {
        ...
        '@type': 'AboutPage',
        name: 'About Sprunki Beats',
        url: 'https://sprunkibeats.online/about',
        description: 'Learn about Sprunki Beats, our mission, and the team behind the game.',
        publisher: {
            '@type': 'Organization',
            name: 'Sprunki Beats',
...
export const metadata: Metadata = {
    title: 'About Us – Sprunki Beats',
    description: 'Learn about Sprunki Beats, our mission, and the team behind the game.',
    keywords: ['about Sprunki Beats', 'game team', 'who made Sprunki Beats'],
};
        ...
        <>
            ...
            <div className="page-header">
                <div className="container">
                    <h1 className="gradient-text">About Sprunki Beats</h1>
            ...
            <div className="page-content">
                <h2>Our Story</h2>
                <p>
                    Sprunki Beats was born from a simple idea: what if playing Sprunki Beats could be even simpler and more accessible?. The result is a game
                    that&apos;s instantly intuitive yet endlessly engaging — an experience unlike any other on the web.
                </p>
                <p>
                    We launched Sprunki Beats with a clear vision — to create a free, accessible, and
                    ...
                    Sprunki Beats has something for you.
                </p>
                ...
                <p>
                    Every level in Sprunki Beats is handcrafted with care. We obsess over the details
                    so you can simply enjoy the game.
                </p>

                <h2>What Makes Us Different</h2>
                <p>
                    Sprunki Beats offers a unique experience compared to similar games in its category.
                </p>
                ...
                <p>
                    ...
                    <a href="/contact">Contact page</a>. Your input helps us make Sprunki Beats better for
                    everyone.
                </p>
            </div>
        </>
