...
export const metadata: Metadata = {
    ...
    description: 'Browse the complete sitemap of Sprunki Beats. Find every page on our website including games, blog posts, and information pages.',
    keywords: ['Sprunki Beats sitemap', 'all pages', 'site navigation'],
    alternates: {
...
const sections = [
    {
        ...
        links: [
            { href: '/', label: 'Home' },
            { href: '/play', label: 'Play Sprunki Beats' },
    ...
    },
    {
        ...
        links: [
            ...
            { href: '/blog/what-is-jigsolitaire', label: 'What is Sprunki Beats?' },
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Browse every page on Sprunki Beats.</p>
                </div>
            </div>
