...
export const metadata: Metadata = {
    ...
    description: 'Sprunki Beats is committed to digital accessibility. Learn about our efforts to make our game available to everyone.',
    keywords: ['Sprunki Beats accessibility', 'accessible game', 'web accessibility statement'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Our commitment to making Sprunki Beats accessible to everyone.</p>
                </div>
            </div>

            <div className="page-content">
                <p>
                    Sprunki Beats is committed to ensuring digital accessibility for people with disabilities.
                ...
                <p>
                    We recognize that the game component of Sprunki Beats presents additional accessibility
                ...
                <h2>Feedback</h2>
                <p>
                    We welcome your feedback on the accessibility of Sprunki Beats. If you encounter
                ...
                <ul>
                    ...
                    <li>Email: <strong>accessibility@sprunkibeats.online</strong></li>
                </ul>
                <p>
